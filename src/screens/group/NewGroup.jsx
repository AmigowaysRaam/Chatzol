...
import ButtonComponent from '../../components/Button/Button'; // Ensure this is correct
      ...
      <View style={[styles.header, {
        ...
        <View style={styles.toggleSwitchContainer}>
          ...
          <Switch
            ...
            trackColor={{ false: 'red', true: "COLORS.primary" }} // Customize track color when off and on
      ...
      >
        {
          isLoading ?
            ...
            :
            <Text style={[styles.buttonText, Louis_George_Cafe.bold.h6, , { color: "#FFF", fontWeight: "600", }]}>{"Create Group"}</Text>
        }
      </TouchableOpacity>
