  ...
  const HeaderComponent = () => (
    <LinearGradient colors={["#252525", "#000"]} style={styles.headContainer}>
      ...
      <View style={styles.profileContainer}>
        <Image source={{ uri: userItem?.image ? userItem?.image : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT0JTGnXof5ByjBODlxpYeGsW_rK1tlLZcwLg&s" }} style={styles.profileImage} />
...
const styles = StyleSheet.create({
  ...
  profileImage: {
    ...
    borderRadius: 25,  // Makes the profile image circular
  ...
  cardContainer: {
    ...
    // Push the card slightly from the edges
  },
  itemContainer: {
    marginBottom: hp(1),
